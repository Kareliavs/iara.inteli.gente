...
def executar_etl_csv(caminho_csv: str, entidade: str, separador=";", encoding="utf-8"):
...
if __name__ == "__main__":
    caminho_csv = "dados/Acesso_SCM_min_12Mbps.csv"
    executar_etl_csv(caminho_csv, "municipio_apresenta_variavel")
